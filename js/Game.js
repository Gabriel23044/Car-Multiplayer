class Game {
  ...
  showLife() {
    push();
    image(lifeImage, width / 2 - 550, height - player.positionY - 200, 20, 20);
    fill("white");
    rect(width / 2 - 500, height - player.positionY - 200, 185, 20);
    fill("#f50057");
    rect(width / 2 - 500, height - player.positionY - 200, player.life, 20);
    noStroke();
    pop();
  }
  ...
  showFuelBar() {
    push();
    image(fuelImage, width / 2 - 550, height - player.positionY - 160, 20, 20);
    fill("white");
    rect(width / 2 - 500, height - player.positionY - 160, 185, 20);
    fill("#ffc400");
    rect(width / 2 - 500, height - player.positionY - 160, player.fuel, 20);
    noStroke();
    pop();
  }
